        ...
        <form action="{{ route('appointments.store') }}" method="POST" id="formAgendamento">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-x-16 gap-y-12 items-start">
                ...
                <div class="space-y-10">
                    ...
                    <!-- INFORMAÇÕES DE PAGAMENTO (só desktop: abaixo dos serviços, deixa a tela mais compacta) -->
                    <div class="hidden lg:block">
                        @include('appointments.partials.payment-info')
                    </div>
                ...
                <div class="space-y-10">
                    ...
                    <!-- INFORMAÇÕES DE PAGAMENTO (mobile: aqui embaixo do botão; no desktop fica na coluna da esquerda) -->
                    <div class="lg:hidden">
                        @include('appointments.partials.payment-info')
                    </div>
